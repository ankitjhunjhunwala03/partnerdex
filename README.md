...
| **Trialing** | Current trial subscription value grouped by each expected trial end date. A usage-priced plan contributes zero: it has no contracted price to forecast, and its revenue depends on consumption nobody has committed to. |
