...
4. **Plan Upgrades/Downgrades:** Shopify models plan changes by cancelling the old subscription and creating a new one. PartnerDex correlates these events within `PLAN_CHANGE_WINDOW_DAYS` to avoid reporting upgrades as churn.
